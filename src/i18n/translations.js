...
export const translations = {
  en: {
    ...
    drawer: {
      ...
      sectionFeedbackPlatform: 'Platform reviews',
      sectionFeedbackLocal: 'From local divers',
      feedbackReviews: '{count} reviews',
      feedbackChecked: 'Checked {date}',
      feedbackStale: 'May be outdated',
      sourceNaverBlog: 'Naver Blog',
      sourceKakaoMap: 'KakaoMap',
  ...
  zh: {
    ...
    drawer: {
      ...
      sectionFeedbackPlatform: '平台评价',
      sectionFeedbackLocal: '本地潜水员的反馈',
      feedbackReviews: '{count} 条评价',
      feedbackChecked: '核实于 {date}',
      feedbackStale: '可能已过时',
      sourceNaverBlog: 'Naver 博客',
      sourceKakaoMap: 'Kakao 地图',
      sourceGoogleMaps: '谷歌地图',
      sourceTripadvisor: '猫途鹰',
      sourceReddit: 'Reddit',
      contactEmail: '邮箱',
  ...
  ja: {
    ...
    drawer: {
      ...
      sectionFeedbackPlatform: 'プラットフォームのレビュー',
      sectionFeedbackLocal: '地元ダイバーの声',
      feedbackReviews: 'レビュー{count}件',
      feedbackChecked: '{date} 確認',
      feedbackStale: '情報が古い可能性あり',
      sourceNaverBlog: 'NAVERブログ',
      sourceKakaoMap: 'カカオマップ',
      sourceGoogleMaps: 'Googleマップ',
      sourceTripadvisor: 'トリップアドバイザー',
      sourceReddit: 'Reddit',
      contactEmail: 'メール',
  ...
  ko: {
    ...
    drawer: {
      ...
      sectionFeedbackPlatform: '플랫폼 리뷰',
      sectionFeedbackLocal: '현지 다이버의 의견',
      feedbackReviews: '리뷰 {count}개',
      feedbackChecked: '{date} 확인',
      feedbackStale: '오래된 정보일 수 있음',
      sourceNaverBlog: '네이버 블로그',
      sourceKakaoMap: '카카오맵',
      sourceGoogleMaps: '구글 지도',
      sourceTripadvisor: '트립어드바이저',
      sourceReddit: '레딧',
      contactEmail: '이메일',
